...
export class MainGroupComponent implements OnInit, OnDestroy {
  ...
  private userphone: number = +localStorage.getItem('telephone');
  ...
  set _inviteNodeClicked(_value: boolean) {
    ...
    this._invitation_img_URL = value ?
      'assets/icons/invitations_black.png' :
      'assets/icons/invitations_white.png';
    this._invitation_fill = value ?
      'fill: #ffffff' :
      'fill: #0e3944';
    this.inviteNodeClicked = value;
  }
  _inviteConfirm_img_url:string = 'assets/icons/check_white.png';
  _invitation_img_URL: string = 'assets/icons/invitations_white.png';
  ...
  ngOnInit(): void {
    ...
    this.getInvitations(this.userphone);
  }
